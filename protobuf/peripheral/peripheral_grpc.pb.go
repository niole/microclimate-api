...
type PeripheralManagementServiceClient interface {
	...
	RemovePeripheral(ctx context.Context, in *Peripheral, opts ...grpc.CallOption) (*apipb.Empty, error)
}
...
func (c *peripheralManagementServiceClient) RemovePeripheral(ctx context.Context, in *Peripheral, opts ...grpc.CallOption) (*apipb.Empty, error) {
	out := new(apipb.Empty)
...
type PeripheralManagementServiceServer interface {
	...
	RemovePeripheral(context.Context, *Peripheral) (*apipb.Empty, error)
...
func (UnimplementedPeripheralManagementServiceServer) RemovePeripheral(context.Context, *Peripheral) (*apipb.Empty, error) {

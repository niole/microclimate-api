...
type PeripheralMeasurementEventServiceClient interface {
	ReceiveEvent(ctx context.Context, in *MeasurementEvent, opts ...grpc.CallOption) (*apipb.Empty, error)
...
func (c *peripheralMeasurementEventServiceClient) ReceiveEvent(ctx context.Context, in *MeasurementEvent, opts ...grpc.CallOption) (*apipb.Empty, error) {
	out := new(apipb.Empty)
...
type PeripheralMeasurementEventServiceServer interface {
	ReceiveEvent(context.Context, *MeasurementEvent) (*apipb.Empty, error)
...
func (UnimplementedPeripheralMeasurementEventServiceServer) ReceiveEvent(context.Context, *MeasurementEvent) (*apipb.Empty, error) {

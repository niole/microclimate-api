...
type DeploymentManagementServiceClient interface {
	...
	RemoveDeployment(ctx context.Context, in *RemoveDeploymentRequest, opts ...grpc.CallOption) (*apipb.Empty, error)
}
...
func (c *deploymentManagementServiceClient) RemoveDeployment(ctx context.Context, in *RemoveDeploymentRequest, opts ...grpc.CallOption) (*apipb.Empty, error) {
	out := new(apipb.Empty)
...
type DeploymentManagementServiceServer interface {
	...
	RemoveDeployment(context.Context, *RemoveDeploymentRequest) (*apipb.Empty, error)
...
func (UnimplementedDeploymentManagementServiceServer) RemoveDeployment(context.Context, *RemoveDeploymentRequest) (*apipb.Empty, error) {
